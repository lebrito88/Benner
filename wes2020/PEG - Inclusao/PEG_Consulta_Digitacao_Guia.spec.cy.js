...
it('Digitação de Guias - Incluindo dados do Protocolo', () => {   
    ...
    cy.get('#ctl00_Main_PROTOCOLO_FORM_toolbar > .blue').click().should('be.visible')       
    cy.wait(1000)
    ...
    cy.get('#ctl00_Main_GUIA_CONSULTA_FORM_PageControl_GUIACONSULTA_GUIACONSULTA_GUIAPRESTADOR').type('474747')
    ...
    cy.get(':nth-child(2) > .col-md-12 > .form-group > :nth-child(2) > :nth-child(1) > .input-group > .select2 > .selection > .select2-selection').type('010037116200')
    cy.wait(1000)   
    cy.get('.select2-results__option').click()
    cy.wait(1000)   
    ...
    //Selecionar Endereço do Prestador Executante
     cy.get(':nth-child(4) > :nth-child(2) > :nth-child(1) > .input-group > .select2 > .selection > .select2-selection').click()
     cy.wait(1000)
    ...
    cy.get('#ctl00_Main_GUIA_CONSULTA_FORM_PageControl_GUIACONSULTA_GUIACONSULTA_NUMEROCONSELHOPROFISSIONAL').type('444555')
   ...
   //17 - Indicação de Acidente - OUTROS
    ...
    cy.wait(1000)
    cy.get('#ctl00_Main_GUIA_CONSULTA_FORM_PageControl_GUIACONSULTA_GUIACONSULTA_VALORAPRESENTADO').type('200')
    cy.wait(1000)
